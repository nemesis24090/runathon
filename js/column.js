            ...
            if($("#comment_content").val().length>0){
                ...
                jQuery.ajax({
                    ...
                    success:function($data){
                        ...
                        if($data==true){
                        $("#comment_content").val("");
                        $(".comment-list-panel").prepend('<div class="media"><a class="pull-left" href=""><img class="media-object img-circle comment-img" src="'+base_url+"/profile_pic/"+profile_pic+'"></a><div class="media-body"><h4 class="media-heading">'+user_name+'</h4><small><span class="comment-timestamp" data-livestamp="'+new Date()+'"></span></small><br>'+content+'</div></div>');
                        }
                    else
